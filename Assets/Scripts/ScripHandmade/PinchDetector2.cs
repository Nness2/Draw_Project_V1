...
namespace Leap.Unity {
  ...
  /// </summary>
  public class PinchDetector2 : AbstractHoldDetector {
    ...
    protected override void ensureUpToDate() {
      ...
      _position = ((hand.Fingers[1].TipPosition + hand.Fingers[2].TipPosition) * .5f).ToVector3();
    ...
    protected override void OnDrawGizmos () {
      if (ShowGizmos && _handModel != null && _handModel.IsTracked) {
        ...
        if (IsHolding) {
          ...
          Hand hand = _handModel.GetLeapHand();
          if (hand != null) {
            Finger thumb = hand.Fingers[1];
            Finger index = hand.Fingers[2];
